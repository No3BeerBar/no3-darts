 ...
 * in vitest (tsconfig jsx:preserve). Asserts the patron-visible Ready path
 * stays wired in source.
 */
...
describe("TakeoutBanner", () => {
  it("is a client component with Ready control while takeout is active", () => {
